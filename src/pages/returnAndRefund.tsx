          ...
          <div className="container-luxe relative z-10">
            ...
            >
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                ...
                satisfied, we're here to help with a seamless return process.
              </p>
            </motion.div>
          </div>
        </section>
              ...
              <div className="lg:col-span-8 space-y-12">
                ...
                >
                  ...
                  <p className="text-muted-foreground mb-4">
                    Certain types of items cannot be returned for hygiene or
                    safety reasons:
                  </p>
                  <div className="grid sm:grid-cols-2 gap-4">
                    {[
                      "Perishable goods (food, flowers)",
                      "Intimate apparel & sanitary goods",
                      "Gift cards",
                      ...
                      <div
                        key={i}
                        className="flex items-center gap-2 text-sm text-muted-foreground bg-secondary/50 p-3 rounded-lg"
                      >
                  ...
                  >
                    ...
                    >
                      ...
                      <AccordionContent className="text-muted-foreground pb-4">
                        Visit our Returns Center, enter your order number and
                        email address to start. Follow the instructions and
                        select the items you want to return. Once your request
                        is approved, you will get a confirmation email with
                        shipping guidelines.
                      </AccordionContent>
                    </AccordionItem>
                    <AccordionItem
                    ...
                    >
                      ...
                      <AccordionContent className="text-muted-foreground pb-4">
                        ...
                        or rejection of your refund. If approved, your refund
                        will be processed, and a credit will automatically be
              ...
              <div className="lg:col-span-4 space-y-6">
                <div className="bg-card rounded-2xl p-8 shadow-sm border border-border/50 sticky top-24">
                  ...
                  <p className="text-muted-foreground mb-6 text-sm">
                    Ready to start your return? Have your order number and email
                    handy.
                  </p>
