        ...
        <div className="max-w-7xl mx-auto px-4 lg:px-8 mt-12">
          <div className="max-w-4xl space-y-12 text-left">
            ...
            <section id="overview" className="scroll-mt-28 space-y-4">
              ...
              <div className="text-gray-600 text-lg lg:text-xl leading-relaxed space-y-4 font-light text-left">
                ...
                <p>
                  ...
                  product availability, weather conditions, or courier service
                  operations.
                </p>
              </div>
            </section>
            ...
            <section id="order-processing" className="scroll-mt-28 space-y-4">
              ...
              <div className="text-gray-600 text-lg lg:text-xl leading-relaxed space-y-4 font-light text-left">
                <p>
                  All orders are usually processed within 1–3 business days
                  after payment confirmation.
                </p>
                <p>
                  Orders placed on weekends or public holidays may be processed
                  on the next working business day.
                </p>
                <p>
                  Once your order has been shipped, you will receive a shipping
                  confirmation message or email along with tracking details.
                </p>
              </div>
            </section>
            ...
            <section id="shipping-timelines" className="scroll-mt-28 space-y-4">
              ...
              <div className="text-gray-600 text-lg lg:text-xl leading-relaxed space-y-4 font-light text-left">
                ...
                <p>
                  ...
                  occasionally be delayed due to external factors beyond our
                  control.
                </p>
              </div>
            </section>
            ...
            <section id="shipping-charges" className="scroll-mt-28 space-y-4">
              ...
              <div className="text-gray-600 text-lg lg:text-xl leading-relaxed space-y-4 font-light text-left">
                ...
                <p>
                  Shipping charges are non-refundable unless our side caused the
                  issue.
                </p>
              </div>
            </section>
            ...
            <section id="order-tracking" className="scroll-mt-28 space-y-4">
              ...
              <div className="text-gray-600 text-lg lg:text-xl leading-relaxed space-y-4 font-light text-left">
                <p>
                  Once your order is dispatched, tracking information will be
                  shared via email, SMS, or WhatsApp.
                </p>
                <p>
                  Customers can use the tracking details to monitor shipment
                  progress directly through the courier partner’s website.
                </p>
              </div>
            </section>
            ...
            <section id="delayed-failed" className="scroll-mt-28 space-y-4">
              ...
              <div className="text-gray-600 text-lg lg:text-xl leading-relaxed space-y-4 font-light text-left">
                ...
                <p>
                  If a delivery attempt fails due to incorrect customer
                  information or repeated unavailability, re-shipping charges
                  may apply.
                </p>
              </div>
            </section>
            ...
            <section id="damaged-packages" className="scroll-mt-28 space-y-4">
              ...
              <div className="text-gray-600 text-lg lg:text-xl leading-relaxed space-y-4 font-light text-left">
                ...
                <p>We will investigate the issue and assist accordingly.</p>
              </div>
            </section>
            ...
            >
              ...
              <div className="text-gray-600 text-lg lg:text-xl leading-relaxed space-y-4 font-light text-left">
                <p>
                  Currently, Protein and Nutrients may only ship within India.
                  International shipping availability may vary and will be
                  updated on our website when applicable.
                </p>
              </div>
            </section>
            ...
            <section id="contact-us" className="scroll-mt-28 space-y-4">
              ...
              <div className="text-gray-600 text-lg lg:text-xl leading-relaxed space-y-6 font-light text-left">
                <p>
                  For shipping-related support or delivery questions, please
                  contact us:
                </p>
