...
const ORDER_DETAILS = {
  ...
  items: [
    {
      ...
      brand: "Brandify",
      image:
        "https://images.unsplash.com/photo-1598033129183-c4f50c736f10?q=80&w=2525&auto=format&fit=crop",
    ...
    },
    {
      ...
      brand: "SoftStep",
      image:
        "https://images.unsplash.com/photo-1586350977771-b3b0abd50c82?q=80&w=2526&auto=format&fit=crop",
  ...
  timeline: [
    ...
    },
    {
      ...
      completed: true,
      description: "Item has been shipped via BlueDart.",
    },
    {
    ...
    },
    {
      ...
      completed: true,
      description: "Item delivered to Amit Das.",
    },
  ],
};
    ...
    return {
      ...
      timeline: [
        ...
        },
        {
          ...
          description: "Item has been shipped via courier.",
        },
        {
          status: "Delivered",
          date: dbOrder.deliveredAt || "",
          completed: !!dbOrder.deliveredAt,
          description: `Item delivered to ${dbOrder.shippingName}.`,
        },
      ],
    };
  }, [dbOrder]);
                    ...
                    {order.timeline.map((step, index) => {
                      ...
                      return (
                        ...
                        >
                          {/* Icon Circle */}
                          <div
                            className={`w-12 h-12 rounded-full border-4 flex items-center justify-center flex-shrink-0 transition-colors ${
                              isCompleted
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm font-medium text-foreground">
                        Shipped via {order.courier.name}
                      </p>
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="mt-3 text-xs text-muted-foreground flex items-center gap-1">
                          ...
                          {new Date(item.returnWindow).toLocaleDateString()}
                        </div>
                      </div>
                    </div>
                  ))}
                    ...
                    <p className="text-xs text-blue-600 dark:text-blue-400 mt-0.5">
                      ...
                      <span className="font-bold">
                        ...
                        {order.items
                          .reduce(
                            (acc, item) =>
                              acc + (item.originalPrice - item.price),
                            0,
                          )
                          .toLocaleString()}
                      </span>{" "}
