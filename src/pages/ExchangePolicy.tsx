          ...
          <div className="max-w-4xl space-y-12 text-left">
            ...
            <section id="overview" className="scroll-mt-28 space-y-4">
              ...
              <div className="text-gray-600 text-lg lg:text-xl leading-relaxed space-y-4 font-light text-left">
                <p>
                  At Fuel and Nutrients, we take great care in delivering
                  premium-quality supplements in perfect condition. If you
                  receive a damaged, defective, or incorrect product, you may
                  request an exchange according to the policy outlined below.
                </p>
                <p>
                  Exchange requests are subject to product inspection,
                  availability, and approval by our support team.
                </p>
              </div>
            </section>
            ...
            <section id="eligibility" className="scroll-mt-28 space-y-4">
              ...
              <div className="text-gray-600 text-lg lg:text-xl leading-relaxed space-y-4 font-light text-left">
                <p className="font-semibold text-black">
                  Products may qualify for exchange if:
                </p>
            ...
            <section id="non-exchangeable" className="scroll-mt-28 space-y-4">
              ...
              <div className="text-gray-600 text-lg lg:text-xl leading-relaxed space-y-4 font-light text-left">
                ...
                <p className="text-[#5BBF3D] font-medium">
                  For hygiene and safety reasons, opened nutrition and
                  supplement products cannot be exchanged.
                </p>
              </div>
            </section>
            ...
            <section id="shipping" className="scroll-mt-28 space-y-4">
              ...
              <div className="text-gray-600 text-lg lg:text-xl leading-relaxed space-y-4 font-light text-left">
                <p className="font-semibold text-black">
                  If the exchange is approved due to:
                </p>
                <ul className="space-y-2.5">
                  {[
                ...
                <p>Fuel and Nutrients may cover the exchange shipping costs.</p>
                <p>
                  Additional shipping charges may apply for exchanges requested
                  for other reasons.
                </p>
              </div>
            </section>
            ...
            <section id="approval" className="scroll-mt-28 space-y-4">
              ...
              <div className="text-gray-600 text-lg lg:text-xl leading-relaxed space-y-4 font-light text-left">
                <p>
                  All exchange requests are reviewed individually. Fuel and
                  Nutrients reserves the right to reject exchange requests if:
                </p>
                <ul className="space-y-2.5">
                  {[
            ...
            <section id="availability" className="scroll-mt-28 space-y-4">
              ...
              <div className="text-gray-600 text-lg lg:text-xl leading-relaxed space-y-4 font-light text-left">
                <p>
                  ...
                  replacement product is unavailable, we may:
                </p>
                <ul className="space-y-2.5">
                  {[
            ...
            <section id="contact-us" className="scroll-mt-28 space-y-4">
              ...
              <div className="text-gray-600 text-lg lg:text-xl leading-relaxed space-y-6 font-light text-left">
                <p>For exchange-related assistance, please contact:</p>
