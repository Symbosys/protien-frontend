          ...
          <div className="max-w-4xl space-y-12 text-left">
            ...
            <section id="overview" className="scroll-mt-28 space-y-4">
              ...
              <div className="text-gray-600 text-lg lg:text-xl leading-relaxed space-y-4 font-light text-left">
                <p>
                  Welcome to Protein and Nutrients. By accessing our website,
                  placing an order, or using our services, you agree to comply
                  with the following Terms & Conditions.
                </p>
                <p>
                  These terms are designed to ensure a secure, fair, and
                  transparent experience for all customers using our platform.
                </p>
                <p>
            ...
            <section id="products-info" className="scroll-mt-28 space-y-4">
              ...
              <div className="text-gray-600 text-lg lg:text-xl leading-relaxed space-y-4 font-light text-left">
                <p>
                  ...
                  pricing, and information displayed on our website are accurate
                  and up to date.
                </p>
                ...
                <p>
                  Fuel and Nutrients reserves the right to correct errors or
            ...
            <section id="shipping-delivery" className="scroll-mt-28 space-y-4">
              ...
              <div className="text-gray-600 text-lg lg:text-xl leading-relaxed space-y-4 font-light text-left">
                <p>
                  ...
                  location, courier operations, and external factors.
                </p>
                <p className="font-semibold text-black">
                  Fuel and Nutrients is not responsible for delays caused by:
                </p>
                <ul className="space-y-2.5">
                  {[
                    "Courier disruptions",
            ...
            <section id="returns-refunds" className="scroll-mt-28 space-y-4">
              ...
              <div className="text-gray-600 text-lg lg:text-xl leading-relaxed space-y-4 font-light text-left">
                ...
                <p>
                  Certain products, including opened supplement containers, may
                  not qualify for returns due to hygiene and safety reasons.
                </p>
              </div>
            </section>
            ...
            >
              ...
              <div className="text-gray-600 text-lg lg:text-xl leading-relaxed space-y-4 font-light text-left">
                ...
                <p>
                  is the property of Fuel and Nutrients and protected under
            ...
            <section id="liability" className="scroll-mt-28 space-y-4">
              ...
              <div className="text-gray-600 text-lg lg:text-xl leading-relaxed space-y-4 font-light text-left">
                <p className="font-semibold text-black">
                  Fuel and Nutrients shall not be held liable for:
                </p>
                <ul className="space-y-2.5">
                  {[
                ...
                <p>
                  Customers are advised to use supplements responsibly and
            ...
            <section id="modifications" className="scroll-mt-28 space-y-4">
              ...
              <div className="text-gray-600 text-lg lg:text-xl leading-relaxed space-y-4 font-light text-left">
                <p>
                  Fuel and Nutrients reserves the right to update or modify
                  these Terms & Conditions at any time without prior notice.
                </p>
                <p>
                  Changes will become effective immediately upon publication on
                  this page.
                </p>
              </div>
            </section>
            ...
            <section id="governing-law" className="scroll-mt-28 space-y-4">
              ...
              <div className="text-gray-600 text-lg lg:text-xl leading-relaxed space-y-4 font-light text-left">
                ...
                <p>
                  Any disputes arising from website use or purchases shall be
