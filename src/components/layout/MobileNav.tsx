...
export default function MobileNav() {
  ...
  // Hide general bottom nav bar on product detail pages to give full priority to sticky Add to Cart bar
  if (location.pathname.startsWith('/product/')) {
    return null;
  }

  return (
    <nav className="fixed bottom-0 left-0 right-0 z-40 lg:hidden bg-white/95 backdrop-blur-xl border-t border-gray-100 pb-safe shadow-lg">
